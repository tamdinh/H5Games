...
function Engine() {
    ...
    // menu.append("<li><a href='http://www.17w67.com/index.html?from=djsl'>More Games</a></li>");
    CONTROL.clickOn(".konw-us", this.konwUs)
}
Engine.prototype.konwUs = function(event) {
    $(".dropdown-toggle").dropdown('toggle');
    $(".modal-title").text("About Us");
    $(".modal-body").html("We are committed to providing a pure gaming experience.<br>Sharing the game with more people is the best way to support us.<br>If you have any suggestions, please feel free to let us know.<br>WeChat Subscription: happy_games");
    ENGINE.showModal()
};
