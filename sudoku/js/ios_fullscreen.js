...
$(document).ready(function () {
    // Skip if running in an iframe or not in Safari
    if (window.self !== window.top || !platform || platform.name !== "Safari") {
        return;
    }
    
    // Only run on iPhone Safari
    if(platform.product === "iPhone") {
