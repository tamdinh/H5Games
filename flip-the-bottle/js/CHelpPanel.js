function CHelpPanel(){
    ...
    this._init = function(){
        ...
        var oParent = this;
        _oPanelContainer.on("pressup",function(){oParent._onExitHelp()});
    ...
    this.initText = function(){
        ...
        _oText1 = new createjs.Text(TEXT_HELP1,FONT_SIZE_HELP+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText2 = new createjs.Text(TEXT_HELP2,FONT_SIZE_HELP+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        ...
        _oText3 = new createjs.Text(TEXT_HELP3,FONT_SIZE_HELP+PRIMARY_FONT, PRIMARY_FONT_COLOUR);
    ...
    this.unload = function(){
        ...
        createjs.Tween.get(_oPanelContainer).to({y:_pStartPanelPos.y},400, createjs.Ease.backIn).call(function(){                
                ...
                var oParent = this;
                _oPanelContainer.off("pressup",function(){oParent._onExitHelp();});
            });
    };
