function CEndPanel(iScore){
    ...
    this._init = function(){
        ...
        _oMsgTextGameOver = new createjs.Text(TEXT_GAMEOVER, FONT_SIZE_END_PANEL_TITLE+ PRIMARY_FONT, PRIMARY_FONT_COLOUR);
	...
	_oMsgTextGameOver.x = CANVAS_WIDTH_HALF;
        ...
        _oMsgTextGameOver.lineWidth = 580;
	...
	_oMsgTextFinalScore.x = CANVAS_WIDTH_HALF;
        _oMsgTextFinalScore.y = CANVAS_HEIGHT_HALF - 30;
        _oMsgTextFinalScore.lineWidth = 550;
	_oPanelContainer.addChild(_oMsgTextFinalScore);
	
        _oMsgTextFinalLines = new createjs.Text(TEXT_BEST_SCORE + ": " + s_iBestScore, FONT_SIZE_END_PANEL_TEXT + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oMsgTextFinalLines.textAlign = "center";
        _oMsgTextFinalLines.textBaseline = "alphabetic";
	_oMsgTextFinalLines.x = CANVAS_WIDTH_HALF;
        _oMsgTextFinalLines.y = _oMsgTextFinalScore.y + 30;
        _oMsgTextFinalLines.lineWidth = 550;
	_oPanelContainer.addChild(_oMsgTextFinalLines);
        
        _oMsgTextCredits = new createjs.Text(TEXT_CREDITS + ": " + s_iTotalCredits, FONT_SIZE_END_PANEL_TEXT + PRIMARY_FONT, PRIMARY_FONT_COLOUR);
        _oMsgTextCredits.textAlign = "center";
        _oMsgTextCredits.textBaseline = "alphabetic";
	_oMsgTextCredits.x = CANVAS_WIDTH_HALF;
        _oMsgTextCredits.y = _oMsgTextFinalLines.y + 30;
        _oMsgTextCredits.lineWidth = 550;
	_oPanelContainer.addChild(_oMsgTextCredits);
